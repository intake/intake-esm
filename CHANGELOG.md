...
- Allow users to specify exclude*dirs for CMIP collections (:pr:`63`) & (:issue:`62`) `Anderson Banihirwe`*
- Keep CMIP6 `tracking_id` in merge*keys (:pr:`67`) `Anderson Banihirwe`*
